    ...
    <div class="offcanvas-body p-0">
        <div data-simplebar="" class="h-100">
            <div class="p-4">
                ...
                <p class="text-muted">Choose Light or Dark ______. </p>
...
<!-- <script src="<?php echo base_url('assets/js/pages/dashboard-crm.init.js'); ?>"></script> -->
<!-- jQuery -->
